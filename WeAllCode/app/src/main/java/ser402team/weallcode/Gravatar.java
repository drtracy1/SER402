...
/**
 * @author: tkeunebr
 * https://github.com/tkeunebr/gravatar-android/blob/master/gravatar-android/src/fr/tkeunebr/gravatar/Gravatar.java
 */
public class Gravatar {
     ...
     */
    public GravRequestBuilder with(String email) {
        return new GravRequestBuilder(this, email);
    }
